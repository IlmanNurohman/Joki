...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($userExists > 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO bayi_balita (nama, jenis_kelamin, berat_badan, tinggi_badan, nama_ibu, alamat, tanggal_pendataan, user_id) 
                               VALUES (:nama, :jenis_kelamin, :berat_badan, :tinggi_badan, :nama_ibu, :alamat, :tanggal_pendataan, :user_id)");
        // Bind values
        if ($stmt->execute([
            ':nama' => $nama, 
...
<body>
    ...
    <div class="container mt-4">
        <div class="container">
            <h4><i class="bi bi-journals"></i>Data Bayi/Balita</h4>
            ...
            <!-- Card for the form -->
             ...
             <a href="lihat_data_bayi_balita.php" class="btn btn-primary mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="data_bayi_balita.php" method="POST" id="formPendataan">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Bayi/Balita</label><span>*</span>
                        ...
                        <div class="mb-3">
                            <label for="berat_badan" class="form-label">Berat Badan (kg)</label><span>*</span>
                            <input type="number" step="0.01" class="form-control" id="berat_badan" name="berat_badan"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="tinggi_badan" class="form-label">Tinggi Badan (cm)</label><span>*</span>
                            <input type="number" class="form-control" id="tinggi_badan" name="tinggi_badan" required>
                        </div>
                        <div class="mb-3">
                            <label for="nama_ibu" class="form-label">Nama Ibu</label><span>*</span>
