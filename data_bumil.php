...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($userExists > 0) {
        // Lanjutkan proses insert ke tabel data_bumil
        $stmt = $pdo->prepare("INSERT INTO data_bumil (nama, nama_suami, usia_ibu, usia_kandungan,  alamat, tanggal_pendataan, user_id) 
                               VALUES (:nama, :nama_suami, :usia_ibu, :usia_kandungan,  :alamat, :tanggal_pendataan, :user_id)");
        // Bind values
        if ($stmt->execute([
            ':nama' => $nama, 
...
<body>
    ...
    <div class="container mt-4">
        <div class="container">
            <h4><i class="bi bi-journals"></i>Data Bumil</h4>
            ...
            <!-- Card for the form -->
             ...
             <a href="lihat_data_bumil.php" class="btn btn-primary mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="data_bumil.php" method="POST" id="formPendataan">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="nama_suami" class="form-label">Nama Suami</label><span>*</span>
                            <input type="text" class="form-control" id="nama_suami" name="nama_suami" required>
                        </div>
                        <div class="mb-3">
                            <label for="usia_ibu" class="form-label">Usia_Ibu (Tahun)</label><span>*</span>
                            <input type="number"  class="form-control" id="usia_ibu" name="usia_ibu"required>
                        </div>
                        <div class="mb-3">
                            <label for="usia_kandungan" class="form-label">Usia Kandungan (Minggu)</label><span>*</span>
                            <input type="number" class="form-control" id="usia_kandungan" name="usia_kandungan" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label><span>*</span>
