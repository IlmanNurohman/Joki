...
<head>
    ...
    <title>Lihat Data Bayi/Balita</title>
...
<body>
    ...
    <div class="container mt-4">
        <h3><i class="bi bi-journals"></i>Data Bayi/Balita</h3>

        <form class="d-flex mb-3" method="GET" action="lihat_data_bayi_balita.php">
        ...
        <div class="custom-container">
            <a href="data_bayi_balita.php" class="btn btn-primary mb-3">
            ...
            <div class="accordion-container border p-3">
                ...
                <div class="accordion" id="dataAccordion">
                    <?php foreach ($groupedDataPage as $tanggal => $bayiList): ?>
