...
<body>
    ...
    <div class="container mt-4">
        ...
        <h3><i class="bi bi-journals"></i>Data KB</h3>

        <form class="d-flex mb-3" method="GET" action="lihat_data_kb.php">
            <input class="form-control me-2" type="search" placeholder="Cari..." aria-label="Search" name="search" value="<?php echo htmlspecialchars($searchTerm); ?>">
            <button class="btn btn-primary  btn-custom" type="submit">Cari</button>
        </form>
        <div class="custom-container">
    <a href="data_kb.php" class="btn btn-primary mb-3">
    ...
    <div class="accordion-container border p-3">
        ...
        <div class="accordion" id="dataAccordion">
            <?php foreach ($groupedDataPage as $tanggal => $kbList): ?>
                    ...
                    <div class="accordion-body">
                        <div class="table-responsive-custom">
                            <table class="table table-custom">
                                <thead>
                                    <tr>
                                        <th><input type="checkbox" id="selectAll-<?php echo $tanggal; ?>" /></th>
                                        <th>Nama</th>
                                        <th>Jenis KB</th>
                                ...
                                <tbody>
                                    <?php foreach ($kbList as $data): ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="selected[]" value="<?php echo $data['id']; ?>" />
                                        </td>
                                        <td><?php echo $data['nama']; ?></td>
                                        <td><?php echo $data['jenis_kb']; ?></td>
