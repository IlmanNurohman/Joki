...
$totalBulan = count($groupedData);

// Tentukan jumlah halaman
$totalPages = ceil($totalBulan / $accordionPerPage);

// Ambil data untuk halaman saat ini
$bulanKeys = array_keys($groupedData);
$bulanKeysPage = array_slice($bulanKeys, $offset, $accordionPerPage);

// Hanya tampilkan data berdasarkan tanggal pada halaman saat ini
$groupedDataPage = [];
foreach ($bulanKeysPage as $bulan) {
    $groupedDataPage[$bulan] = $groupedData[$bulan];
}
...
<head>
    ...
    <title>Lihat Data Vitamin</title>
...
<body>
    ...
    <div class="container mt-4">
        <h3><i class="bi bi-journals"></i>Data Pemberian Vitamin</h3>

        <form class="d-flex mb-3" method="GET" action="lihat_data_vitamin.php">
        ...
        <div class="custom-container">
            <a href="data_vitamin.php" class="btn btn-primary mb-3">
            ...
            <div class="accordion-container border p-3">
                ...
                <div class="accordion" id="dataAccordion">
                    <?php foreach ($groupedDataPage as $bulan => $vitaminList): ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?php echo $bulan; ?>">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapse-<?php echo $bulan; ?>" aria-expanded="true"
                                aria-controls="collapse-<?php echo $bulan; ?>">
                                Tanggal Pendataan: <?php echo $bulan; ?>
                            </button>
                        </h2>
                        <div id="collapse-<?php echo $bulan; ?>" class="accordion-collapse collapse"
                            aria-labelledby="heading-<?php echo $bulan; ?>" data-bs-parent="#dataAccordion">
                            <div class="accordion-body">
                                <div class="table-responsive-custom">
                                    <table class="table table-custom">
                                        ...
                                        <tbody>
                                            <?php foreach ($vitaminList as $data): ?>
                                            <tr>
                                                <td><?php echo $data['bulan']; ?></td>
                                                <td><?php echo $data['jumlah_bayi_laki']; ?></td>
                                                <td><?php echo $data['jumlah_bayi_perempuan']; ?></td>
                                                <td><?php echo $data['total_bayi']; ?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
